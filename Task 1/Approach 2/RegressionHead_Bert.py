...
class BERTRegressionModel(nn.Module):
    def __init__(self, bert_model, regression_head_date, regression_head_content, regression_head_username, regression_head_media, regression_head_company):
    ...
    def forward(self, input_ids_date, attention_mask_date, input_ids_content, attention_mask_content, input_ids_username, attention_mask_username, input_ids_media, attention_mask_media, input_ids_company, attention_mask_company):
        # Embeddings for date
        ...
        combined_output = regression_output_date + regression_output_content + regression_output_username + regression_output_media + regression_output_company
