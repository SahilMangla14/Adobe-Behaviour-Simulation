...
def train_model(model, train_dataloader, criterion, optimizer, device, num_epochs=30):
    ...
    for epoch in range(num_epochs):
        ...
        for batch in train_dataloader:
            ...
            outputs = model(date_input_ids, date_attention_mask, content_input_ids, content_attention_mask, username_input_ids, username_attention_mask, company_input_ids, company_attention_mask)
