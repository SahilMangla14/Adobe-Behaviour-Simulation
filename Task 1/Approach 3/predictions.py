...
model.load_state_dict(torch.load('./Results2/regression_model.pth'))
scaler_likes = joblib.load('./Results2/scaler_likes.joblib')
scaler_company_rank = joblib.load('./Results2/scaler_company_rank.joblib')
scaler_epoch_time = joblib.load('./Results2/scaler_epoch_time.joblib')
scaler_username_rank = joblib.load('./Results2/scaler_username_rank.joblib')
